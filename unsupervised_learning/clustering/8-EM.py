...
def expectation_maximization(X, k, iterations=1000, tol=1e-5,
    ...
    Args:
        ...
        tol: A non-negative float containing the tolerance used for
            early stopping.
        verbose: A boolean determining whether log-likelihood
    ...
    if verbose:
        print("Log Likelihood after 0 iterations: {}".format(round(likelihood, 5)))
    ...
    for iteration in range(1, iterations + 1):
        ...
        if g is None or new_likelihood is None:
            return None, None, None, None, None
